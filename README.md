...
```
variableGroups: 
    - coreai-techspike-document-analysis-api-snd1
    - coreai-techspike-document-analysis-api-snd2
    - coreai-techspike-document-analysis-api-snd3
variables:
    - coreai-techspike-document-analysis-api-APPINSIGHTS-CONNECTIONSTRING
```
